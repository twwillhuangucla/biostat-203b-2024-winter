...
```{bash}
#| eval: true
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, '{ print $6}' | head -1
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, 'NR > 1 { print $6}' | sort | uniq -c
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, '{ print $8}' | head -1
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, 'NR > 1 { print $8}' | sort | uniq -c
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, '{ print $10}' | head -1
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, 'NR > 1 { print $10}' | sort | uniq -c
zcat < ~/mimic/hosp/admissions.csv.gz | awk -F, '{ print $13}' | head -1
