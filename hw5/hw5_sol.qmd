...
```{r}
#Preprocessing
logit_recipe <- recipe(los_long ~ ., data = data_train) |>
...
# Preprocessing
boost_recipe <- recipe(los_long ~ ., data = data_train) |>
  step_impute_mean(all_numeric_predictors()) |>
  step_impute_mode(all_nominal_predictors()) |>
  step_dummy(all_nominal_predictors()) |>
  step_zv(all_numeric_predictors()) |>
...
```{r}
# Preprocessing
mlp_recipe <- recipe(los_long ~ ., data = data_train) |>
  step_impute_mean(all_numeric_predictors()) |>
  step_impute_mode(all_nominal_predictors()) |>
  step_dummy(all_nominal_predictors()) |>
  step_zv(all_numeric_predictors()) |>
...
```{r}
# Preprocessing
stack_recipe <- recipe(los_long ~ ., data = data_train) |>
  step_impute_mean(all_numeric_predictors()) |>
  step_impute_mode(all_nominal_predictors()) |>
  step_dummy(all_nominal_predictors()) |>
  step_zv(all_numeric_predictors()) |>
